...
👉 **[CLIQUE AQUI para abrir a Documentação Executiva em PDF](./docs/Celnet_Analytics_Documentacao_Final_BI.pdf)** (Contém a definição do problema, as 12 medidas DAX, o modelo Star Schema e regras de RLS).
